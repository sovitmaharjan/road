<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="weekend.aspx.cs" Inherits="attendance.pages.Cancellation.Weekend.weekend" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">Weekend Subsitute Cancellation</li>
                        </ol>
                ...
                <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <div class="well">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2">Weekend <span style="color: red">*</span></label>
                                <div class="col-md-4">
                                    <asp:DropDownList ID="DDLWeekendList" CssClass="form-control" AutoPostBack="true" runat="server" OnSelectedIndexChanged="DDLWeekendList_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtRemarks" CssClass="form-control" ReadOnly="true" AutoComplete="off" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
