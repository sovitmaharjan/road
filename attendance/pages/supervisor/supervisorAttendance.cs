...
{
    public class supervisorAttendance
    {
        int j;
        string query;
        ...
        public DataTable sidebarSubMenu1(int id)
        {
            ...
            string query = "select * from tblSubMenu1 where menuId = " + id + "and status = 1";
            return queryFunction(query);
        }
        ...
        public DataTable branch(int id)
        {
            ...
            if (id == 0)
            {
                ...
                query = "select * from tbl_comp_branch";
            }
            else
            {

                query = "select * from tbl_comp_branch where BRANCH_ID =" + id;
            }
            return queryFunction(query);
        }
        ...
        )
        {
            ...
            if (id == 0)
            {
                ...
                query = "insert into Tbl_Comp_Branch (BRANCH_NAME, ISOUTBRANCH, serial_no, BRANCH_CODE, status ) values('"
                    + branchName + "', '"
                    + isOutBranch + "', 0, '"
                    + branchCode + "', '"
                    + status + "')";
        ...
        public DataTable grade(int id)
        {
            ...
            if (id == 0)
            {
                ...
                query = "Select * from Tbl_Org_Grade";
            }
            else
            {

                query = "select * from Tbl_Org_Grade where GRADE_ID =" + id;
            }
            return queryFunction(query);
        }
        ...
        )
        {
            ...
            if (id == 0)
            {
                ...
                query = "insert into Tbl_Org_Grade (GRADE_NAME,GRADE_TYPE,LEVEL,FLDTYPE,SERIAL_NO,status) values('"
                    + gradeName + "', '"
                    + gradeType + "', '', '', '', '"
                    + status + "')";
            }
        ...
        public DataTable designation(int id)
        {
            ...
            if (id == 0)
            {
                ...
                query = "select * from Tbl_Org_Desg order by DEG_ID desc";
            }
            else
            {

                query = "select * from Tbl_Org_Desg where DEG_ID =" + id;
            }
            return queryFunction(query);
        }
        ...
        )
        {
            ...
            string query = "exec proc_managedeg '"
                + designationName + "', '"
                + id + "', '"
                + status + "'";
            queryFunction(query);
        ...
        public DataTable leave(int id)
        {
            ...
            if (id == 0)
            {
                ...
                query = "select t.*,(case when t.LEAVE_TYPE='1' then 'Expire Yearly' when t.LEAVE_TYPE='2' then 'Accumulative' else 'Service Period' end) as TYPE from Tbl_Org_Leave_info t";
            }
            else
            {

                query = "select t.*,(case when t.LEAVE_TYPE='1' then 'Expire Yearly' when t.LEAVE_TYPE='2' then 'Accumulative' else 'Service Period' end) as TYPE from Tbl_Org_Leave_info t where LEAVE_ID =" + id;
            }
            return queryFunction(query);
        }
        ...
        public DataTable holiday(int id)
        {
            ...
            if (id == 0)
            {
                ...
                query = "select t.*,(case when t.holidayType='1' then 'Standard' when t.holidayType='2' then 'Specific' else 'Unofficial' end) as TYPE from Tbl_Org_Holiday t";
            }
            else
            {
        ...
        public DataTable subMenu2(int id)
        {
            ...
            string query = "select * from tblSubMenu2 where subMenu1Id = " + id;
            return queryFunction(query);
        }
        ...
        {
            string sql = "select COUNT(DEPT_ID) as dept from Tbl_Org_Dept where FLDTYPE='D' and status = 1";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "select COUNT(DEPT_ID) as dept from Tbl_Org_Dept where FLDTYPE='D' and status = 0";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "select COUNT(DEPT_ID) as section from Tbl_Org_Dept where FLDTYPE='S' and status = 1";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "select COUNT(DEPT_ID) as section from Tbl_Org_Dept where FLDTYPE='S' and status = 0";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "select EMP_ID,emp_Fullname, EMP_PHOTO, DEG_NAME, BRANCH_NAME, sect_name, DEPT_NAME, EMP_DOB from view_emp_info where month(EMP_DOB) = month(getdate()) and day(EMP_DOB) >= day(getdate()) ORDER BY day(EMP_DOB)";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        public void CreateOfficialInfo(int deg_id, int HOD_ID, int mode_id, int dept_id, int branch_id, int status_id, int Grade_id, int emp_id, int PID, int usertypeid, int login_id, string login_password)
        {
            con.Open();
        ...
        {
            string sql = "Select DEPT_ID,DEPT_NAME, DEPT_PARENT, status from Tbl_Org_Dept where LEVEL=1";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "Select DEPT_ID,DEPT_NAME, DEPT_PARENT, status from Tbl_Org_Dept where LEVEL=2";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        public DataTable getleaveNameAssignedonly(int PID)
        {
        ...
        public DataTable getLeaveEmployeeList(int leaveid, int DEPT_ID, int BRANCH_ID)
        {
            string sql = "select EMP_ID , emp_Fullname from view_Emp_Info ve inner join tbl_emp_leave tel on ve.PID=tel.PID where tel.LEAVEID=@LEAVE_ID and ve.DEPT_ID=@DEPT_ID and ve.BRANCH_ID=@BRANCH_ID and status_id = 1";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            cmd.Parameters.AddWithValue("@LEAVE_ID", leaveid);
        ...
        {
            string sql = "select BRANCH_ID,BRANCH_NAME from Tbl_Comp_Branch where status = 1 order by BRANCH_NAME asc";
            con.Open();
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        {
            string sql = "select * from rpt_attendance_data_datewise";
            SqlCommand cmd = new SqlCommand(sql, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        public DataTable DailyAbsent(DateTime sdate, DateTime edate, string dept_id)
        {
