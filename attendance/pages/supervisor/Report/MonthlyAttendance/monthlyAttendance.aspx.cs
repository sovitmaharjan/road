        ...
        protected void BtnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (Chkemp.Checked)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    blu.QuickAttnReport(eid, branch_id, dept_id, Startdate, Enddate, flag);
                    flag = 1;
                }
                Response.Redirect(String.Format("monthlyAttendanceList?Startdate={0}&Enddate={1}&eid={2}&emp_branch={3}&emp_dept={4}&branch_id={5}&dept_id={6}", Server.UrlEncode(Startdate.ToString()), Server.UrlEncode(Enddate.ToString()), Server.UrlEncode(eid.ToString()), Server.UrlEncode(emp_branch.ToString()), Server.UrlEncode(emp_dept.ToString()), Server.UrlEncode(branch_id.ToString()), Server.UrlEncode(dept_id.ToString())));
            }
            else
            {
                ...
                blu.QuickAttnReport(eid, branch_id,dept_id, Startdate, Enddate, flag);
                Response.Redirect(String.Format("monthlyAttendanceList?Startdate={0}&Enddate={1}&eid={2}&emp_branch={3}&emp_dept={4}&branch_id={5}&dept_id={6}&emp_name={7}", Server.UrlEncode(Startdate.ToString()), Server.UrlEncode(Enddate.ToString()), Server.UrlEncode(eid.ToString()), Server.UrlEncode(emp_branch.ToString()), Server.UrlEncode(emp_dept.ToString()), Server.UrlEncode(branch_id.ToString()), Server.UrlEncode(dept_id.ToString()), Server.UrlEncode(emp_name.ToString())));
            }
        }
