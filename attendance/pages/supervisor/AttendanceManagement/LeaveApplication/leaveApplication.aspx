<%@ Page Title="" Language="C#" MasterPageFile="~/pages/supervisor/supervisor.Master" AutoEventWireup="true" CodeBehind="leaveApplication.aspx.cs" Inherits="attendance.pages.supervisor.AttendanceManagement.LeaveApplication.leaveApplication" %>
