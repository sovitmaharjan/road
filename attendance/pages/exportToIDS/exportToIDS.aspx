<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="exportToIDS.aspx.cs" Inherits="attendance.pages.exportToIDS.exportToIDS" %>
        ...
        <div class="container">
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <div class="col-md-8 col-md-offset-4">
                    <div class="col-md-3">
                        <asp:Button ID="BtnLoad" CssClass="btn btn-success col-md-12" runat="server" Text="Export" OnClick="BtnLoad_Click" />
                    </div>
