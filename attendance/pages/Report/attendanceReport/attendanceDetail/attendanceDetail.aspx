<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="attendanceDetail.aspx.cs" Inherits="attendance.pages.Report.attendanceReport.attendanceDetail.attendanceDetail" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="blue">Attendace Reports</li>
                            <li class="active">Late Attendance Report
                            </li>
                        </ol>
                    ...
                    <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="condition" CssClass="form-control" runat="server" ToolTip="condition List">
                                        <asp:ListItem Enabled="true" Text="Select Any" Selected="true" Value="-1"></asp:ListItem>
                                        <asp:ListItem Text="Early Sign In Records" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Late Sign In Records" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Early Sign Out Records" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Late Sign Out Records" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </ContentTemplate>
