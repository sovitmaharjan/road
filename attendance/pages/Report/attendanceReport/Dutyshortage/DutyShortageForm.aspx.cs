...
{
    public partial class DutyShortageForm : System.Web.UI.Page
    {
        ...
        protected void BtnLoad_Click(object sender, EventArgs e)
        {
                ...
                foreach (GridViewRow row in GridView.Rows)
                {
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            blu.DutyShortage(startDate, endDate, dept_name, flag);
                            flag = 1;
                        }
                        else
                        {
            ...
            else
            {
                ...
                blu.DutyShortage(startDate, endDate, dept_name, flag);
                //deptname = CmbDepartment.SelectedItem.ToString();
            }

            Response.Redirect("DutyShortageReport?startDate=" + startDate + "&endDate=" + endDate);
        }
    }
}