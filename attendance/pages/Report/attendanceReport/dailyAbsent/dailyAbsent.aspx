<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="dailyAbsent.aspx.cs" Inherits="attendance.pages.Report.attendanceReport.dailyAbsent.dailyAbsent" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">DailyAbsent Attendance Report
                            </li>
                        </ol>
                    ...
                    <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="CmbDepartment" CssClass="form-control" runat="server" ToolTip="Department List" AutoPostBack="True" OnSelectedIndexChanged="CmbDepartment_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtEmpId" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtEmpId_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridView" runat="server"
                                                ShowHeader="True"
                                                Font-Size="Small"
                                                OnRowCreated="GridView_RowDataBound"
