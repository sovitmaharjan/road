<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="ViewIndividualLeaveTakenSummary.aspx.cs" Inherits="attendance.pages.Report.leaveReport.IndividualLeaveTakenSummary.ViewIndividualLeaveTakenSummary" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">Individual Leave Taken Summary
                            </li>
                        </ol>
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <div class="col-md-12 form-group" style="font-weight: bold;">
                    <asp:Panel ID="Panel2" runat="server">
                        <div class="col-md-12" hidden="">
                            <asp:Label ID="Label1" runat="server" Text="Individual Leave Taken Summary"></asp:Label>
                        </div>
                    </asp:Panel>
                </div>
            </form>
