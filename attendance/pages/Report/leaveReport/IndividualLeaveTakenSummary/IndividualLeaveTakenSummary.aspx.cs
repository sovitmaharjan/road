...
{
    public partial class IndividualLeaveTakenSummary : System.Web.UI.Page
    {
        ...
        protected void BtnLoad_Click(object sender, EventArgs e)
        {
                ...
                foreach (GridViewRow row in GridView.Rows)
                {
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            blu.IndividualLeaveTakenSummary(startDate, endDate, dept_name, flag);
                            flag = 1;
                        }
                        else
                        {
            ...
            Response.Redirect("ViewIndividualLeaveTakenSummary?startDate=" + startDate + "&endDate=" + endDate + "&branchName=" + branchName);
        }
    }
}