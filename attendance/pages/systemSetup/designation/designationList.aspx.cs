...
namespace attendance.pages.systemSetup.designation {
    public partial class designationList : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            DataTable dtDesignationList = attendanceObject.designation(0);
            string tableBodyRow = "";
            int i = 1;
            foreach (DataRow value in dtDesignationList.Rows) {
                ...
                tableBodyRow += "<td><div class='button-list'><a href='designation?b80bb7740288fda1f201890375a60c8f=" + value["DEG_ID"] + "' class='btn btn-warning w-xs waves-effect waves-light btn-xs'><i class='mdi mdi-pencil'></i> <span>Edit </span></a></div></td>";
                tableBodyRow += "</tr>";
                i++;
            }
