<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="designation.aspx.cs" Inherits="attendance.pages.systemSetup.designation.designation" %>
                            ...
                            <form class="form-horizontal" runat="server">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="designationNameForm" class="form-control" value="" name="designationNameForm" required="required" runat="server" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9 col-sm-offset-2">
                                            <div class="button-list">
                                                ...
                                                <a class="btn btn-danger btn-bordered waves-effect w-md waves-light col-md-1" href="~/designationList" runat="server">Cancel </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
