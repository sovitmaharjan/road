    ...
    public partial class section : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                condition.Add("DEPT_PARENT", Request.Params["i"].Replace("%20", " "));
                ...
                foreach (DataRow value in dtTableData.Rows)
                {
                    ...
                    tableBodyRow += "<td><div class='button-list'><button type='button' id='" + value["DEPT_ID"] + "' class='btn btn-warning w-xs waves-effect waves-light btn-xs edit' data-toggle='modal' data-target='#addContent'><i class='mdi mdi-pencil'></i> Edit</button></div></td>";
                    tableBodyRow += "</tr>";
                    i++;
                }
        ...
        protected void saveClick(object sender, EventArgs e)
        {
            ...
            data.Add("DEPT_NAME", sectionName.Value);
            ...
            Dictionary<string, object> condition = new Dictionary<string, object>();
            condition.Add("DEPT_ID", id.Value);
