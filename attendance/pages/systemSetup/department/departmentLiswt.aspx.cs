...
namespace attendance.pages.systemSetup.department {
    public partial class departmentList : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            DataTable dtBranchList = attendanceObject.department(0);
            string tableBodyRow = "";
            int i = 1;
            foreach (DataRow value in dtBranchList.Rows) {
                ...
                tableBodyRow += "<td><div class='button-list'><a href='department?b80bb7740288fda1f201890375a60c8f=" + value["DEPT_ID"] + "' class='btn btn-warning w-xs waves-effect waves-light btn-xs'><i class='mdi mdi-pencil'></i> <span>Edit </span></a></div></td>";
                tableBodyRow += "</tr>";
                i++;
            }
