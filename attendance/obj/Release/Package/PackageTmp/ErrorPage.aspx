<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorPage.aspx.cs" Inherits="attendance.ErrorPage" %>
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <div class="wrapper-page">
                        ...
                        <p class="text-muted">
                            ...
                            You might want to check your Permission or Contact System Administrator for further Assistance.
                        </p>

                        <a class="btn btn-success waves-effect waves-light m-t-20" href="<%=this.baseUrl%>">Return Home</a>
                    </div>
