<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="deleteLeave.aspx.cs" Inherits="attendance.pages.delete.deleteLeave" %>
                    ...
                    <ContentTemplate>
                        <div class="well">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="CmbEmployee" CssClass="form-control" runat="server"  ToolTip="Employee List" AutoPostBack="true"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="CmbLeave" CssClass="form-control" runat="server" ToolTip="Leave List" OnSelectedIndexChanged="CmbLeave_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                                        ...
                                        <asp:GridView ID="GridView" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="LEave Id">
                                                    <ItemTemplate>
                                                        <asp:Label ID="LEAVE_ID" runat="server" Text='<%# Eval("LEAVE_ID") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Given Month">
                                                    <ItemTemplate>
                                                        <asp:Label ID="GIVENMONTH" runat="server" Text='<%# Eval("GIVENMONTH") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Given Day">
                                                    <ItemTemplate>
                                                        <asp:Label ID="GIVENDAY" runat="server" Text='<%# Eval("GIVENDAY") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Aprroved By">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Opening Leave">
                                                    <ItemTemplate>
                                                        <asp:Label ID="op_flag" runat="server" Text='<%# Eval("op_flag") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
