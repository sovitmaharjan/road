<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="addEmployee.aspx.cs" Inherits="attendance.pages.hrManagement.employee.addEmployee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
                        ...
                        <form id="form1" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 pull-right">
                                    ...
                                    <asp:FileUpload ID="file" onchange="readURL(this);" runat="server" Height="22px" accept=".png,.jpg,.jpeg,.gif" /><br />
                                ...
                                <ContentTemplate>
                                    <div class="well">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <asp:TextBox ID="txtEmployeeId" CssClass="form-control" runat="server" AutoPostBack="false" autocomplete="off" onkeyup="x1()"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="EMP_FIRSTNAME" CssClass="form-control" autocomplete="off" placeholder="FIRSTNAME" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtStartDate" CssClass="form-control englishDate7" AutoComplete="off" placeholder="YYYY-MM-DD" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtNepaliDate" CssClass="form-control nepaliDate7" placeHolder="YYYY-MM-DD" AutoComplete="off" runat="server"></asp:TextBox>
                                            </div>

                                            <label class="control-label col-md-2">Join Date <span style="color: red">*</span></label>
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtJoindate" CssClass="form-control englishDate8" placeHolder="YYYY-MM-DD" AutoComplete="off" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtjoin" CssClass="form-control nepaliDate8" placeHolder="YYYY-MM-DD" AutoComplete="off" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                Female
                                                <asp:RadioButton GroupName="Gender" ID="Gender2" value="M" runat="server" />
                                                Male
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:DropDownList ID="CmbNationality" CssClass="form-control" runat="server" ToolTip="Nation List"></asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:DropDownList ID="CmbPDistrict" CssClass="form-control" runat="server" ToolTip="District List" AutoPostBack="true" OnSelectedIndexChanged="CmbPDistrict_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:DropDownList ID="CmbTState" CssClass="form-control" runat="server" ToolTip="Provinces List" AutoPostBack="true" OnSelectedIndexChanged="CmbTState_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            <label class="control-label col-md-2">District </label>
                                            <div class="col-md-2">
                                                <asp:DropDownList ID="CmbTDistrict" CssClass="form-control" runat="server" ToolTip="District List" AutoPostBack="true" OnSelectedIndexChanged="CmbTDistrict_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            <label class="control-label col-md-2">City</label>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtDateIssued" autocomplete="off" CssClass="form-control englishDate7" placeholder="YYYY-MM-DD" runat="server"></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtPIDate" CssClass="form-control englishDate7" placeholder="YYYY-MM-DD" runat="server"></asp:TextBox>
                                            </div>
                                            <asp:Label ID="lblPEDate" CssClass="control-label col-md-2" runat="server" Text="Label"> Expiry Date</asp:Label>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtPEDate" CssClass="form-control englishDate8" placeholder="YYYY-MM-DD" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div class="well">
                                        <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="CmbBranch" CssClass="form-control" runat="server" ToolTip="Branch List"></asp:DropDownList>
                                                    </div>

                                                    <label class="control-label col-md-2">Department <span style="color: red">*</span></label>
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="CmbDepartment" CssClass="form-control" onkeyup="x1()" runat="server" ToolTip="Department List"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-md-2">HOD <span style="color: red">*</span></label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:DropDownList ID="CmbType" AutoPostBack="true" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2">PF No <span style="color: red">*</span></label>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="txtPf" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                            <label class="control-label col-md-2">CIT <span style="color: red">*</span></label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2">SSF <span style="color: red">*</span></label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:RadioButton GroupName="webLogin" ID="RadioButton1" value="E" runat="server" />
                                                Enable
                                                <asp:RadioButton GroupName="webLogin" ID="RadioButton2" value="D" Checked="true" runat="server" />
                                                Disable
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <asp:GridView ID="GVLeave" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Permission">
                                                        <ItemTemplate>
                                                            <asp:RadioButton ID="rbPer" GroupName="rbPer" runat="server" />
                                                            Yes
                                                    <asp:RadioButton ID="rbPer1" GroupName="rbPer" Checked="true" runat="server" />
                                                            No
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        function x1() {
            var t1 = document.getElementById('<%=txtEmployeeId.ClientID%>').value;
            document.getElementById('<%=txtUserid.ClientID%>').value = t1;
        }

        $(document).ready(function () {

            var timer;
            $('#<%=txtEmployeeId.ClientID%>').on('keyup', function () {

                clearTimeout(timer);
                timer = setTimeout(function (event) {

                    var t1 = $('#<%=txtEmployeeId.ClientID%>').val();
                    $.ajax({

                        method: 'post',
                        data: '{employeeId:' + t1 + '}',
                        url: 'pages/hrManagement/employee/addEmployee.aspx/CheckDuplicate',
                        ...
                        success: function (data) {
                            ...
                            if (data.d == 1) {
                                ...
                                swal("Oops!", "This id is already assigned!", "warning")
                            } else {
                                $('#<%=txtUserid.ClientID%>') = t1;
                            }
                        }
                    })
                }, 1000);
