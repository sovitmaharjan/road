<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="DutyShortageForm.aspx.cs" Inherits="attendance.pages.Report.attendanceReport.Dutyshortage.DutyShortageForm" %>
            ...
            <form runat="server" role="form" class="form-horizontal">
                <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <asp:TextBox ID="TxtNepaliDate2" CssClass="form-control nepaliDate2" AutoComplete="off" placeholder="Nepali Date" runat="server"></asp:TextBox>
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
                            </div>
