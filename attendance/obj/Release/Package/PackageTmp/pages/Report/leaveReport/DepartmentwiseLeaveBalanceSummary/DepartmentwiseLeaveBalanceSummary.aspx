<%@ Page Title="" Language="C#" MasterPageFile="~/attendanceMaster.Master" AutoEventWireup="true" CodeBehind="DepartmentwiseLeaveBalanceSummary.aspx.cs" Inherits="attendance.pages.Report.leaveReport.DepartmentwiseLeaveBalanceSummary.DepartmentwiseLeaveTakenSummary" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">Departmentwise Leave Balance Summary
                            </li>
                        </ol>
