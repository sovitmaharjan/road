<%@ Page Title="" Language="C#" MasterPageFile="~/pages/supervisor/supervisor.Master" AutoEventWireup="true" CodeBehind="monthlyAttendance.aspx.cs" Inherits="attendance.pages.supervisor.Report.MonthlyAttendance.monthlyAttendance" %>
    ...
    <div class="content">
        <div class="container">
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <asp:CheckBoxList ID="chkAllEmployees" CssClass="table table-striped table-bordered table-hover table-responsive table-info" runat="server" OnSelectedIndexChanged="chkAllEmployees_SelectedIndexChanged"></asp:CheckBoxList>
